...
ActiveRecord::Schema.define(version: 20_180_922_105_239) do
  ...
  create_table 'spree_variant_property_rule_conditions', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[variant_property_rule_id option_value_id], name: 'index_spree_variant_prop_rule_conditions_on_rule_and_optval'
  end
  ...
  create_table 'spree_wallet_payment_sources', id: :integer, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[user_id payment_source_id payment_source_type], name: 'index_spree_wallet_payment_sources_on_source_and_user', unique: true
